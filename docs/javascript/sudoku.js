...
Sudoku.prototype.drawBoard = function(){
    ...
    var sudoku_statistics = $('<div></div>')
                                .addClass('statistics')
    .html('<b>Completados:</b> <span class="cells_complete">'+ this.cellsComplete +'/'+this.cellsNr +'</span> <b>Tiempo:</b> <span class="time">' + this.secondsElapsed + '</span>');
    ...
    //draw gameover
    var sudoku_gameover = $('<div class="gameover_container"><div class="gameover">Felicidades Guapisima! <button class="restart">Volver a jugar</button></div></div>');
